...
export default function CheckEmailPage() {
	...
	return (
		<div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4'>
			...
			<Card className='w-full max-w-3xl relative backdrop-blur-sm bg-white/80 border-0 shadow-2xl shadow-blue-500/10'>
				<CardHeader className='text-center pb-4'>
					{/* Animated Mail Icon */}
					<div className='mx-auto w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center mb-6 shadow-lg relative'>
						...
						<div className='bg-blue-50 rounded-lg p-4 border border-blue-200'>
							<div className='flex items-start gap-3'>
								...
								<div>
									...
									<p className='text-xs text-blue-700 mt-1'>
										The link will take you to a secure page
						...
						<div className='flex items-start gap-3'>
							...
							<div>
								...
								<p className='text-xs text-amber-700 mt-1'>
									For security reasons, the reset link will
									expire soon. If it expires, you'll need to
									request a new one.
								</p>
							</div>
						</div>
