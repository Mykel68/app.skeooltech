...
export default function ResetPasswordPage() {
	...
	return (
		<Card className='w-full max-w-md relative backdrop-blur-sm bg-white border-0 shadow-2xl shadow-blue-500/10 z-20'>
			...
			<CardContent className='space-y-6 '>
				...
				>
					...
					<Button
						type='submit'
						className='w-full bg-green-600 hover:from-blue-600 hover:to-indigo-700 text-white font-medium py-2.5 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed'
						disabled={
							isSubmitting ||
							!passwordsMatch ||
							passwordStrength.strength < 2
